...
use constant {
    ...
    TOOLCHAIN_VERSION   => '16.1.0posix-14.0.0-msvcrt-r1',
    TOOLCHAIN_ARCHIVE   => 'winlibs-x86_64-posix-seh-gcc-16.1.0-mingw-w64msvcrt-14.0.0-r1.zip'
};
    ...
    return {
        ...
        build_job_steps => [
            ...
            ### NEXT STEP 11 : Sign libiconv dlls ##############################
            {
                plugin => 'CustomCodeSigning',
                files  => [
                    '<image_dir>/c/bin/libiconv-2__.dll',
            ...
            ### NEXT STEP 12 : Build openssl library ###########################
            {
                ...
                post_configure  => [
                    ...
                    [
                        ...
                        'no-legacy', 'no-makedepend', 'no-docs', 'no-quic',
            ...
            ### NEXT STEP 13 : Sign OpenSSL dlls ###############################
            {
                plugin => 'CustomCodeSigning',
                files  => [
                    '<image_dir>/c/bin/libcrypto-3__.dll',
